...
if lang == "es" then
	 ...
	 text = {}
	 text[1] = [[Suddenly, your instruments go haywire, and your ship careens out of control. The commands aren't responding! Something is wrong with your systems!]]
	 text[2] = [[You've found the cause of the problem. One of the little rodents you transported apparently got out of the crate on the way, and gnawed through some of your ship's circuitry. The creature died in the ensuing short-circuit. You've fixed the damage, and your ship is under control again.]]
